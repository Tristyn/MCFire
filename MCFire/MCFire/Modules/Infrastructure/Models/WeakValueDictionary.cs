...
namespace MCFire.Modules.Infrastructure.Models
{
    ...
    namespace MCFire.Infrastructure.Models
    {
        /// <summary>
        ...
        public class WeakValueDictionary<TKey, TValue> : IDictionary<TKey, TValue>
            where TValue : class
        {
            readonly Dictionary<TKey, WeakReference<TValue>> _dict = new Dictionary<TKey, WeakReference<TValue>>();
            ...
            public bool TryGetValue(TKey key, out TValue value)
            {
                ...
                WeakReference<TValue> wr;
                value = _dict.TryGetValue(key, out wr) ? wr.Target : null;
                return value != null;
            }
            ...
            void Cleanup()
            {
                ...
                var deadKeys = (from kvp in _dict where !kvp.Value.IsAlive select kvp.Key).ToList();

                foreach (var success in deadKeys.Select(key => _dict.Remove(key)))
                {
