...
namespace MCFire.Common.Processing
{
    ...
    public class ChunkPrioritizer
    {
        ...
        // TODO: refactor into PositionChunkPrioritizer (this) and FrustumChunkPrioritizer (Minecrafts implementation, generates whats visible). or just separate methods
        ...
        /// </summary>
        /// <param name="position">The position of the chunk that has changed.</param>
        ...
        /// <summary>
        /// Marks that all chunks need to be regenerated.
        /// </summary>
        public void ResetAllChunks()
        {
            lock (_lock)
            {
                for (var i = 0; i < _generatedChunks.GetLength(0); i++)
                    for (var j = 0; j < _generatedChunks.GetLength(1); j++)
                        _generatedChunks[i, j] = false;
